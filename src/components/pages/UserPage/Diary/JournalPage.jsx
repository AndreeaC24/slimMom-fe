...
export const Journal = () => {
  ...
  return ( 
    <> 
      ...
      <form id="ingredients-form" className="form" action="#" method="POST" role="form">
            <div className="row"> 
                ...
                <div className="col-1">
              <button type="button" className="btn-custom btn-add d-flex justify-content-center align-content-center" onClick={handleAddButtonClick}>+</button>
              </div>
            </div>
          </form>  
            <table className="table table-borderless table-responsive table-wrapper-scroll-y custom-scrollbar mt-5 text-nowrap">
                ...
                <td className="fatimes"> <FaTimes /></td>
                </tr> 
                </tbody>
            </table> 
            </div> 
